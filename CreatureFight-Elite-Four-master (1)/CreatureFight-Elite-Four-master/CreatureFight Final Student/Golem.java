    ...
    public void attack(int idx)
    {
        ...
        else
        {
            ...
            if ( enemyType.equalsIgnoreCase("Electric") )
            {
             ...
             getWorld().showText(" This attack was super effective ", getWorld().getHeight()/2, getWorld().getWidth()/2+26 );
             Greenfoot.delay(30); 
            }
           else if( enemyType.equalsIgnoreCase("Flying") )
            {
              enemy.getHealthBar().add(0);
              getWorld().showText(" This attack had no effective ", getWorld().getHeight()/2, getWorld().getWidth()/2+26 );
              Greenfoot.delay(30);
            }
