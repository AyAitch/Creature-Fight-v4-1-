  ...
  /**
    ...
    public void act() 
    {
        ...
        if( getHealthBar().getCurrent() <= 0 )
        {
            ...
            if( playerWorld.getNewOneCreature(0).getHealthBar().getCurrent() > 1 )
            {
    ...
    public void attack(int idx)
    {
        ...
        else
        {
            ...
            if ( enemyType.equalsIgnoreCase("Electric") )
            {
             ...
             getWorld().showText(" This attack was not very effective ", getWorld().getHeight()/2+26, getWorld().getWidth()/2 );
             Greenfoot.delay(30); 
            }
            ...
            {
              enemy.getHealthBar().add(-60*2);  
              getWorld().showText(" This attack was very effective ", getWorld().getHeight()/2+26, getWorld().getWidth()/2 );
              Greenfoot.delay(30);
            }
