...
public class CreatureWorld extends World
{
    ...
    private void prepareCreatures()
    {
        ...
        //addObject( playerTwoCreature, getWidth() - playerTwoCreature.getImagegetWidth()/2, playerTwoCreature.getImage().getHeight()/2);
    ...
    /**
     * changePlayerOne changes the menu's to the current player one creature
     * @param There is a String parameter called creature 
     * @return Nothing is returned
     * 
     */
    ...
    /**
     * changePlayerTwo changes the menu's to the current player two creature
     * @param There is a String parameter called creature
     * @return Nothing is returned
     */
    ...
    /**
     * getNewOneCreature returns the 2nd element in the player one creatures array
     * @param Their is an int parameter that is called index
     * @return A Creature is returned
     */
    ...
    /**
     *  getNewTwoCreature returns the 3rd element in the player two creatures array
     * @param Their is an int parameter that is called index
     * @return A Creature is returned
     */
